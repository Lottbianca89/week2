 ...
 * ↓ YOUR CODE HERE ↓ */
 var speedLimit = 35
 var  mySpeedLimit = 55 
   if  (mySpeedLimit > speedLimit) {
      console.log("Slow Down!  Mom Is mad")
} else if (mySpeedLimit === speedLimit) {
...
var alarmSet = false
if (alarmSet || weekDay){
   console.log("Sound of alarm1 Time for work!")
}else {
...
if (username == "Timmy456" && "password"==6789 || username == "Tommy123" && password =="123456") {
...
if (studentGrade >= 0 &&  studentGrade <= 6){
   studentClass = "Elemetary"
} else if (stuedntGrade == 7 || studentGrade == 8){
   studentClass = "Middle"
